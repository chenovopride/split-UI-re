...
class NoisyCleanSet:
    def __init__(self, batch_size, json_dir, matching="sort", length=None, stride=None,
    ...
    def __getitem__(self, index):
        ...
        # print("***",type(idx))
        # batch_x = self.noisy_set[idx * self.batch_size:(idx + 1) * self.batch_size]
        # batch_y = self.clean_set[idx * self.batch_size:(idx + 1) * self.batch_size]
        # return batch_x, batch_y

    def __len__(self):
        # return int(np.ceil(len(self.clean_set) / float(self.batch_size)))
